...
<body background="<c:url value='/resources/images/bg.jpg'></c:url>">
<div class="container-container">
<nav class="navbar navbar-inverse" id="navbar-bg">
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/icon.png'></c:url>" alt="NIIT" height="30px" width="70px"></a>
