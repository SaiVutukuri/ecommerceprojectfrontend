...
<tr><td> <img src="<c:url value='/resources/images/${p.id}.png'></c:url>" height="75px" width="75px"></td><td><font color="black"><c:out value="${p.productname}"></c:out></font></td><%-- <td><font color="white"><c:out value="${p.productdesc}"></c:out></font></td><td><font color="white"><c:out value="${p.quantity}"></c:out></font></td> --%><td><font color="black"><c:out value="${p.price}"></c:out></font></td>
