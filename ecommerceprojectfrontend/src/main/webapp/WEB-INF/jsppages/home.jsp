...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      ...
      <img src="<c:url value='/resources/images/i1.jpg'></c:url>" alt="Offer1" style="width:300px;height:200px">
    </div>
...
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="<c:url value='/resources/images/i2.jpg'></c:url>" alt="Offer2" style="width:300px;height:200px">
    </div>
    <div class="flip-box-back">
      <h2>All Offers</h2>
...
<video autoplay muted loop id="myVideo">
  <source src="<c:url value='/resources/images/video.mp4'></c:url>" type="video/mp4">
</video>
</body>
</html>