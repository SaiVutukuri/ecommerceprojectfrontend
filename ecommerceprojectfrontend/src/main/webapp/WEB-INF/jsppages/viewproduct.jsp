...
<style type="text/css">
.button {background-color: #191818; 
    border: none;
    color: white;
    padding: 15px 32px;
    text-align: center;
...
<div class="container">
<center>
<img src="<c:url value='/resources/images/${productAttr.id}.png'></c:url>" height="150px" width="150px"></center>
<br><br><br>
...
<button class="button">ADD TO CART</button></a></td></form>
</security:authorize>
</c:if>
<td><a href="<c:url value='/all/getallproducts/'></c:url>">
<button class="button">BACK TO PREVIOUS PAGE</button></a></td>
</tr>
</tbody>
</table>
${productAttr.id}
